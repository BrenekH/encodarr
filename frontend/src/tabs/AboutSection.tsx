...
export default class AboutSection extends React.Component<{}, IAboutSectionState> {
	...
	render() {
		return (<>
			...
			<p><b>License:</b> This project is licensed under the Mozilla Public License 2.0 a copy of which can be found <a href="https://github.comhttps://github.com/BrenekH/encodarr/blob/master/LICENSE" target="_blank" rel="noreferrer">here</a>)</p>
